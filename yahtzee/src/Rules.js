...
const fourOfKind = new SumDistro({ count: 4, desc: "Sum add dice if 4 are the same" });

// full house scores as flat 25
const fullHouse = new FullHouse({ score: 25, desc: "25 points for a Full House" });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({ score: 30, desc: "30 points for Sm Straight" });
const largeStraight = new LargeStraight({ score: 40, desc: "40 points for Lg Straight" });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50, desc: "50 points. 5 of a kind" });
